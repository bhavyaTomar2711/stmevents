  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-white/40">Your event booking requests</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.08] bg-white/[0.02] py-16">
          ...
          <p className="mb-1 text-sm font-medium text-white/50">No booking requests yet</p>
          <p className="mb-5 text-[12px] text-white/25">Book an event to see your requests here</p>
            ...
            return (
              <div key={booking.id} className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] transition-all duration-300 hover:border-purple-500/20 hover:bg-white/[0.05]">
                ...
                <div className="p-5">
                  ...
                  {/* Event name */}
                  <h3 className="mb-1 text-[16px] font-bold text-white">{booking.event_name || "Event Booking"}</h3>
                  ...
                  {booking.message && (
                    <div className="rounded-xl border border-white/[0.04] bg-white/[0.02] p-3">
                      <p className="text-[9px] font-semibold uppercase tracking-[0.2em] text-white/20">Your Message</p>
