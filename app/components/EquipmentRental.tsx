    ...
    <div>
      <Link href={`/equipment/${item.slug}`} className="group block h-full">
        <div className="glass-card relative flex h-full flex-col overflow-hidden rounded-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_8px_35px_rgba(124,58,237,0.1)]">
          ...
          {/* Bug 5: Handle missing image with placeholder */}
          ...
          <div className="flex flex-1 flex-col px-6 pt-5 pb-6">
            ...
            {/* Name */}
            <h3 className="mt-2 line-clamp-1 text-lg font-bold uppercase tracking-tight text-white">
              {displayName}
            </h3>

            {/* Description — render HTML from RichTextEditor, strip tags for clean display */}
            <div
              className="mt-2 line-clamp-2 flex-1 text-[13px] leading-relaxed text-white/35 [&_p]:m-0"
